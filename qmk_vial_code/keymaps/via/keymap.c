...
const uint8_t RGBLED_RAINBOW_SWIRL_INTERVALS[] PROGMEM = {10, 50, 100};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LAYOUT_default(
        ...
        KC_TRNS, KC_WBAK, KC_MPLY, KC_WFWD, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RESET, 
        KC_NO, KC_TRNS, KC_VOLU, KC_TRNS, KC_TRNS, KC_NO, KC_TRNS, KC_NO, KC_LBRC, KC_RBRC, TG(1), KC_NO),
    ...
    LAYOUT_default(
        ...
        KC_TRNS, RGB_VAD, RGB_TOG, RGB_VAI, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, 
